...
class QuranSurahPage
  ...
  @override
  State<QuranSurahPage> createState() =>
      _QuranSurahPageState();
}

class _QuranSurahPageState
    extends State<QuranSurahPage> {
  // ===============================================================
  // CONTROLLERS
  // ===============================================================
  ...
  QuranReaderSettings _settings =
  const QuranReaderSettings();

  /// رقم بيتغير مع كل تغيير في إعدادات المصحف.
  ///
  /// الهدف منه ضمان إن الـ MushafPageBlock
  /// يعرف إن configuration اتغير.
  ...
  Future<void> _saveSettings(
      QuranReaderSettings value,
      ) async {
    if (!mounted) return;

    // -------------------------------------------------------------
    // منع أي setState بدون تغيير حقيقي
    // -------------------------------------------------------------
    ...
    // IMPORTANT
    //
    // التحديث يحصل أولًا في الواجهة.
    //
    // لا نستنى SharedPreferences.
    // -------------------------------------------------------------
                ...
                itemBuilder:
                  ...
                  _pageBlockKeys
                    ...
                    page.pageNumber,
                        () =>
                        GlobalKey<
                            MushafPageBlockState>(),
                  );

                  // =================================================
                  // IMPORTANT
                  //
                  // settingsRevision + darkMode
                  // يتم تمريرهم بشكل صريح.
                  //
                  // =================================================
