...
class SahihBukharyDetails extends StatefulWidget {
  final Chapter chapterSahihBukhary;

  const SahihBukharyDetails({super.key, required this.chapterSahihBukhary});

  @override
  State<SahihBukharyDetails> createState() => _SahihMuslimDetailsState();
}

class _SahihMuslimDetailsState extends State<SahihBukharyDetails> {
  ...
  List<HadithSahih> _filteredHadiths = [];

  @override
  void initState() {
    super.initState();
    _filteredHadiths = widget.chapterSahihBukhary.hadiths;
  }
                ...
                Positioned.fill(
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final originalIndex =
                          widget.chapterSahihBukhary.hadiths.indexOf(hadith) +
                          1;
