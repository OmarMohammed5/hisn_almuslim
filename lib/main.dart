...
import 'features/quran_audio/data/services/app_audio_handler.dart';
...
void main() async {
  ...
  // Quran Audio — background playback service (audio_service).
  // Must be initialized before runApp() so notification / lock screen /
  // Bluetooth controls are ready before any audio starts playing.
